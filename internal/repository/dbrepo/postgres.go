...
func (m *postgresDBRepo) GetUserByID(id int) (models.User, error) {
	...
	query := `select id, first_name, last_name, email, password, access_level, created_at, upated_at
...
func (m *postgresDBRepo) UpdateReservation(r models.Reservation) error {
	...
	query := `
		update reservations set first_name = $1, last_name = $2, email = $3, 
...
// DeleteReservation Deletes one reservervation by ID
...
// DeleteBlockByID deletes a room by room id restriction
